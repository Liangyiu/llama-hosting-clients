...
export type HostSystemsResponse<Texpand = unknown> = Required<HostSystemsRecord> &
...
export type ServicesResponse<Texpand = unknown> = Required<ServicesRecord> &
	BaseSystemFields<Texpand>;
export type SshKeysResponse<Texpand = unknown> = Required<SshKeysRecord> &
	BaseSystemFields<Texpand>;
export type UserDetailsResponse<Texpand = unknown> = Required<UserDetailsRecord> &
	BaseSystemFields<Texpand>;
export type UserDetailsAdminResponse<Texpand = unknown> = Required<UserDetailsAdminRecord> &
	BaseSystemFields<Texpand>;
